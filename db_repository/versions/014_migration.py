...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['member'].columns['introduction'].drop()
    post_meta.tables['member'].columns['interest'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['member'].columns['introduction'].create()
    post_meta.tables['member'].columns['interest'].drop()
